...
// 返回歌单里指定歌单ID的歌曲
export const getListSongOfSongId = (songListId) => get(`songList/detail?songListId=${songListId}`)
...
//根据歌单id和用户id查询歌单的评分 
export const getByUserAndRand = (params) => get(`rank/getByUserAndRand`, params)
// 通过性别对歌手分类
...
// 获取指定歌单的评分
export const getRankOfSongListId = (songListId) => get(`rank/getById?songListId=${songListId}`)
